...
##Sacamos una muestra de poblaci�n de 100 individuos de los que
## conocemos el precio y el numero de habitaciones de su inmueble en la zona de Chamber� 
...
zAlphaMedio <- 1.96 ## este dato lo sacamos de la tabla, al ser 95%, si quisieramos cambiarl solo habr�a que modificar el valor
...
##Calculamos la desviaci�n tipica del precio 
desviacionPrecio <- sd(unlist(muestraPrecio))
#Mostramos
desviacionPrecio
##Calculamos la desviaci�n tipica del numero de habitaciones
...
## Podremos observar despu�s, los datos que queremos contrastar del enunciado
...
## que los pisos por debajo del limite inferior del intervalo del precio, se situan a�n as� cerca de la media. 
## .Adem�s, podemos afirmar por el intervalo de las habitaciones
...
## contar�n con 2 habitaciones. Por lo que se puede afirmar, que por lo general 
## los pisos analizados de Chamber� contar�n la mayor�a con 1 cuarto y la mayor�a, 
## no superar�n los 1300 euros, situandose muy cercanos a la media. 

## Por tanto, observamos de forma general, que no va a haber una gran variaci�n
...
## Para ello contaremos con un nivel de confianza del 95 % tambi�n y con un tama�o 
## muestra de 100. 
...
##Calculamos la desviaci�n t�pica de la superficie
...
## tienen un tama�o estandar, es decir, todos los habitaculos van a tener practicamente la misma superficie
...
## en cuanto a amplitud. Todo ello, estando muy relacionado con la variaci�n en el precio
## y con el hecho de que la mayor�a de pisos cuenten con 1 solo cuarto. 
## Adem�s, al igual que en los otros casos observamos que los limite se encuentran muy cercanos  a la media
## habiendo a�n as� mayores diferencias. 
...
## del 5%.
## La inmobiliaria quiere asegurar que la superficie de los pisos ser� mayor o igual a
...
## Como nuestro tama�o muestral n = 100 >> 30; utilizaremos una aproximaci�n 
## a la Normal. 

## A continuaci�n, como la desviaci�n tipica es conocida, utilizaremos la siguiente formula
## mediaSuperficie < 61 - zAlpha *(desviacionSuperficie/ sqrt(n))

## Vamos a insertar manualmente el valor de zAlpha
## con un nivel de significaci�n del 5% 
 zAlpha <- 2.49  
 ##Mostramos
 zAlpha
...
if(mediaSuperficie < muSubCero - parteDerecha){
 ...
 ## publicitarse mejor, en este caso, quiere mostrar, respecto a la desviaci�n tipica, que es 
 ## menor o igual a un determinado valor sigma0. 
 
 ## Por otro lado, el tama�o muestral sigue siendo el mismo porque se quiere 
 ## la mayor precisi�n posible. Utilizaremos 20 grados de libertad y un 
 ## nivel de significaci�n del 5 % 
 
 ##  Las hipotesis ser�n las siguientes :
 ...
 ## En este caso, la inmobiliaria no tiene razon por lo que habr�a que ajustar 
